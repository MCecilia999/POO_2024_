...
class Coches:
    ...
    #Nota 1 para utilizar un atributo privado es necesario hacer lo a traves de un metodo publico
    ...
    #Nota 2 para utilizar un metodo privado es necesario hacer lo dentro de un metodo publico
...
class Camionetas(Coches):
  def _init_(self,color,marca,modelo,velocidad,caballaje,plazas,trasera,cerrada):
    super()._init_(color,marca,modelo,velocidad,caballaje,plazas)
